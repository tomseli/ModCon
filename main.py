...
# =============================================================================
        ...
        f = -controller2.control(pendulum.theta1, sp_theta+3.14, dt) + disturb
    else:
        f = 0
    disturb = 0
    ...
    line2.polarr((rect.center[0] - pendulum.l1*200*np.sin(theta1), rect.center[1] + pendulum.l1*200*np.cos(theta1)), theta2, pendulum.l2*200, BLUE)
